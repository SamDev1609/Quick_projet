            ...
            <div class="row gap-0">
               <div class="col-sm-12">
                  <div class="page-title-content d-sm-flex justify-content-sm-between align-items-center">
                     <h4 class="page-title mt-3 mt-md-0">Montants envoyés par client -> Gabon</h4>
      ...
      <br> <br>
            ...
            <th>Total obtenu</th>
              <th>Action</th>
                                 ...
                                 <tbody><?php foreach ($client_stats as $data): ?>
            <tr>
              <td><?= $data['ID'] ?></td>
              ...
              <td>
                <a href="/reports/show/<?= $data['ID']?>" target="blanc" class="btn btn-success btn-sm">Voir détails</a> 
