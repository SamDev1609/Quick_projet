            ...
            <div class="row gap-0">
               <div class="col-sm-12">
                  <div class="page-title-content d-sm-flex justify-content-sm-between align-items-center">
                     <h4 class="page-title mt-3 mt-md-0">Liste de tous clients</h4>
      ...
      <br> <br>
               ...
               <div class="row justify-content-center">
                ...
                <tr>
                  ...
                  <td><?= $data['name'] ?></td>
                  <td>
                    <!-- <a href="/operations/show/<?= $data['tel_customer'] ?>" class="btn btn-primary btn-sm">View</a> -->
                    

                      <a href="/investments/edit/<?= $data['tel_customer'] ?>" onclick="return confirm('Vous souhaitz modifier?')" class="btn btn-warning btn-sm">Supprimer</a>
                     ...
                     <div class="px-3">
                        ...
                        <div class="">
                           <div class="col-md-6 col-lg-12">
                              <div class="card">
                                 <div class="card-body pt-0">
                                    <form action="/customer/save" method="POST"><br>
                                       <div class="mb-3 row">
                                          <!--  <label for="horizontalInput1" class="col-sm-2 col-form-label">Nom client</label> -->
                                          <div class="col-sm-10">
                                             <input type="text" name="name" class="form-control" id="horizontalInput1" placeholder="Nom client">
                                          </div>
                                       </div>
                                       <div class="mb-3 row">
                                          <!--  <label for="horizontalInput2" class="col-sm-2 col-form-label">Phone</label> -->
                                          <div class="col-sm-10">
                                             <input type="text" class="form-control" id="horizontalInput2" name="tel_customer" placeholder="Phone">
                                          </div>
