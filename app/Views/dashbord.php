                                ...
                                <div class="d-flex justify-content-between">                                    
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-2 text-truncate">
                                            <h6 class="text-dark mb-0 fw-semibold fs-20"><?= number_format($profit_total_now)?></h6>
                                            <p class="text-muted mb-0 fw-medium fs-13">Gain GA actuel</p>
                                        </div><!--end media-body-->
                                    </div><!--end media-->
                                    <div class="align-self-center">
                                        <span class="badge bg-success-subtle text-success border border-success px-2">Score :<?= number_format($profit_total_1) ?></span>
                                    </div>
                                </div>                                
                            </div>
                            <!--end card-body-->
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">                                    
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-2 text-truncate">
                                            <h6 class="text-dark mb-0 fw-semibold fs-20"><?= number_format($ts_profit_data)?></h6>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">                                    
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-2 text-truncate">
                                            <h6 class="text-dark mb-0 fw-semibold fs-20"><?= number_format($profittop)?></h6>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">                                    
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-2 text-truncate">
                                            <h6 class="text-dark mb-0 fw-semibold fs-20"><?= number_format($profit_current)?></h6>
                                            <p class="text-muted mb-0 fw-medium fs-13">Gain SN actuel</p>
                                        </div><!--end media-body-->
                                    </div><!--end media-->
                                    <div class="align-self-center">
                                        <span class="badge bg-success-subtle text-success border border-success px-2"> Total profit sn 10</span>
                                    </div>
                                </div> 
                            </div>
                            <!--end card-body-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 align-self-center">
                                        <div class="text-center">
                                            <h6 class="text-dark mb-2 fw-semibold fs-24"><?= number_format($liq_total)?></h6>
                                            <ul class="list-unstyled d-flex text-center justify-content-center url-list mb-0">
                                                <li class="list-item ms-1 mb-1">
                                                    ...
                                                    <span class="fs-13">Ancien budget <?= number_format($last_bp)?></span>                                                                                                      
                                                </li>
